...
/**
 * wpa_ctrl_set_timeout - How long wpa_ctrl_request() waits for a reply
 * (AutoBleem addition, Unix sockets only)
 * @ctrl: Control interface data from wpa_ctrl_open()
 * @timeout_ms: Milliseconds; 0 keeps hostap's 10 seconds
 */
